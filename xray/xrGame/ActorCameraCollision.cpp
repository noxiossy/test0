...
float	camera_collision_character_skin_depth = 0.3f;
float	camera_collision_character_shift_z = 0.2f;
...
static void cammera_shell_character_collide_callback( bool& do_collide, bool bo1, dContact& c, SGameMtl* material_1, SGameMtl* material_2 )
{
	...
	if(!oposite_data->ph_ref_object || !smart_cast<CAI_Stalker*>(oposite_data->ph_ref_object) )
		return;
